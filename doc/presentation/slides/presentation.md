...
# インターン課題の概要（2025 年 9 月追加）

- **課題 1：**  
  野球部タレントマネジメントシステムのプロトタイプ開発。これに必要な必須機能の実装。
  体力測定の記録登録や閲覧、 3 段階の承認フロー（マネージャー → 部員 → コーチ）などの基本機能を含みます。
  詳細は「アプリケーション利用マニュアル」の主な機能参照。

- **課題 2：**  
  より現場で使いやすくするための機能実装。  
  チーム全体および各部員の傾向を時系列グラフで表示する機能を考案・実装しました。

- **課題 3：**  
  情報リテラシーに関するレポート作成  
  情報の取り扱いや AI が IT 業界に及ぼす影響について考察しました。（本アプリには直接関係のない内容です）
